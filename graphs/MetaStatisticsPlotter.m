...
%   GENERAL
%     gstatistics - GroupStatistics object that an object of this class will reference to
...
classdef MetaStatisticsPlotter;
    ...
    methods
        ...
        % MetaStatisticsPlotter - Main Constructor
        %
        %   MP = MetaStatisticsPlotter(GROUP_STAT) Create a MetaStatisticsPlotter object
        %   called MP using a GroupStatistics object called GROUP_STAT that
        %   can be used to perform diverse kinds of meta-analysis plots.
        
            obj.gstatistics = group_statistics;
            obj.idx_to_be_ploted = 1:obj.gstatistics.n_networks;
        ...
        %   analyzed using a double tail p-value defined on P_VAL.
            ...
            if(nargin == 1)
                obj.PlotValues(obj.gstatistics.ntc_stats_values.value, obj.gstatistics.ntc_stats_values.random_values);
            else
                obj.PlotValues(obj.gstatistics.ntc_stats_values.value, obj.gstatistics.ntc_stats_values.random_values,pvalue);
            end
            %Labels in title, y-axis and legends
            tmplh = legend('Measured NTC','Random expectation',1,'Location','NorthWest');
            legend('boxoff')
        ...
        %   analyzed using a double tail p-value defined on P_VAL.     
            ...
            if(nargin==1)
                obj.PlotValues(obj.gstatistics.nodf_vals.value, obj.gstatistics.nodf_vals.random_values);
            else
                obj.PlotValues(obj.gstatistics.nodf_vals.value, obj.gstatistics.nodf_vals.random_values,pvalue);
            end
            %Labels in title, y-axis and legends
            tmplh = legend('Measured NODF','Random expectation',1,'Location','NorthWest');
            legend('boxoff')
        ...
        %   analyzed using a double tail p-value defined on P_VAL.     
            ...
            if(nargin==1)
                obj.PlotValues(obj.gstatistics.qb_vals.value, obj.gstatistics.qb_vals.random_values);
            else
                obj.PlotValues(obj.gstatistics.qb_vals.value, obj.gstatistics.qb_vals.random_values,pvalue);
            end
        ...
        %   subplots across rows and columns is N_ROWS x N_COLS.
            ...
            if(nargin == 1)
                n_rows = floor(sqrt(obj.gstatistics.n_networks));
                n_cols = ceil(obj.gstatistics.n_networks/n_rows);
            elseif(nargin == 2)
                n_cols = ceil(obj.gstatistics.n_networks/n_rows);
            end
            ...
            for i = 1:obj.gstatistics.n_networks
                subplot(n_rows, n_cols, i);
                obj.gstatistics.networks{i}.plotter.use_labels = 0;
                obj.gstatistics.networks{i}.plotter.PlotMatrix();
                title(obj.gstatistics.names{i}, 'FontSize',10);
            end
        ...
        %   subplots across rows and columns is N_ROWS x N_COLS.
            ...
            if(obj.nest_test == 1)
                sig_indices = obj.gstatistics.ntc_stats_values.percent >= 100*(1-pvalue/2.0);
                no_sig_indices = obj.gstatistics.ntc_stats_values.percent <= 50*pvalue;
            elseif(obj.nest_test == 2)
                sig_indices = obj.gstatistics.nodf_vals.percent >= 100*(1-pvalue/2.0);
                no_sig_indices = obj.gstatistics.nodf_vals.percent <= 50*pvalue;
            end
            ...
            for i = 1:obj.gstatistics.n_networks
                subplot(n_rows, n_cols, i);
                obj.gstatistics.networks{i}.plotter.use_labels = 0; %Do not show row/column labels
                obj.gstatistics.networks{i}.plotter.use_isocline = 1;%No isocline inside modules
                obj.gstatistics.networks{i}.plotter.PlotNestedMatrix();
                ...
                title(obj.gstatistics.names{i},'Color',col, 'FontSize',10);
            end
            set(gcf,'Position', [148         213        1142         746]);
        end
        ...
        %   subplots across rows and columns is N_ROWS x N_COLS.
            ...
            sig_indices = obj.gstatistics.qb_vals.percent >= 100*(1-pvalue/2.0);
            no_sig_indices = obj.gstatistics.qb_vals.percent <= 50*pvalue;
            ...
            for i = 1:obj.gstatistics.n_networks
                subplot(n_rows, n_cols, i);
                obj.gstatistics.networks{i}.plotter.use_labels = 0; %Do not show row/column labels
                obj.gstatistics.networks{i}.plotter.plot_iso_modules = 0;%No isocline inside modules
                obj.gstatistics.networks{i}.plotter.PlotModularMatrix();
                col = 'black'; % Color for not significance
        ...
        %   subplots across rows and columns is N_ROWS x N_COLS.
            ...
            for i = 1:obj.gstatistics.n_networks
                subplot(n_rows, n_cols, i);
                obj.gstatistics.networks{i}.plotter.use_labels = 0;
                obj.gstatistics.networks{i}.plotter.PlotGraph();
                title(obj.gstatistics.names{i}, 'FontSize',10);
            end
        ...
        %   subplots across rows and columns is N_ROWS x N_COLS.
            ...
            for i = 1:obj.gstatistics.n_networks
                subplot(n_rows, n_cols, i);
                obj.gstatistics.networks{i}.plotter.use_labels = 0; %Do not show row/column labels
                obj.gstatistics.networks{i}.plotter.PlotNestedGraph();
                col = 'black'; % Color for not significance
        ...
        %   subplots across rows and columns is N_ROWS x N_COLS.
            ...
            for i = obj.idx_to_be_ploted 
                subplot(n_rows, n_cols, i);
                obj.gstatistics.networks{i}.plotter.PlotModularGraph();
                col = 'black'; % Color for not significance
    ...
    methods(Access = 'protected')
        ...
        %   of the current MetaStatisticsPlotter object.
            ...
            for i = 1:obj.gstatistics.n_networks
                ...
                obj.gstatistics.networks{i}.plotter.cell_color = obj.cell_color;
                obj.gstatistics.networks{i}.plotter.back_color = obj.back_color;
                obj.gstatistics.networks{i}.plotter.line_width = obj.line_width;
                obj.gstatistics.networks{i}.plotter.use_labels = obj.use_labels;
                obj.gstatistics.networks{i}.plotter.font_size = obj.font_size;
                obj.gstatistics.networks{i}.plotter.use_isocline = obj.use_isocline;
                obj.gstatistics.networks{i}.plotter.vertical_margin = obj.vertical_margin;
                obj.gstatistics.networks{i}.plotter.horizontal_proportion = obj.horizontal_proportion;
                obj.gstatistics.networks{i}.plotter.bead_color_rows = obj.bead_color_rows;
                
                obj.gstatistics.networks{i}.plotter.bead_color_columns = obj.bead_color_columns;
                obj.gstatistics.networks{i}.plotter.link_color = obj.link_color;
                obj.gstatistics.networks{i}.plotter.link_width = obj.link_width;
        ...
        %   P_VAL is used.
            ...
            names_matrix = obj.gstatistics.names(sorted_indexes);

            %Find the limits of the error bars using two tail p-value=0.05
            sup_bound = random_values(:,round(obj.gstatistics.replicates * sup_limit));
            low_bound = random_values(:,round(obj.gstatistics.replicates * inf_limit));

            %Plot the data of the real matrices
            clf;
            plot(1:obj.gstatistics.n_networks, values,'o','MarkerFaceColor','red','MarkerEdgeColor','red');
            hold on;
            %Plot the data of the random values
            errorbar(1:obj.gstatistics.n_networks, mean_random_vals, ... 
            ...
            xlim([0 1+obj.gstatistics.n_networks]);
            ylim([0 1]);
