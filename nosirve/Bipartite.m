classdef Bipartite < handle
    ...
    methods
        ...
        function obj = Bipartite(web,namebip)
            ...
            obj.modules = Options.MODULARITY_ALGORITHM;
            ...
            if(Options.ALLOW_ISOLATED_NODES==0)
                [obj.matrix ir ic] = MatrixFunctions.NON_ZERO_MATRIX(obj.matrix);
                obj.webmatrix = MatrixFunctions.NON_ZERO_MATRIX(obj.webmatrix);
                
                obj.row_class = obj.row_class(ir); obj.col_class = obj.col_class(ic);
                obj.row_labels = obj.row_labels(ir); obj.col_labels = obj.col_labels(ic);
            end
