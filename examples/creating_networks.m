...
% the |Reading.m| class. Currently two different formats are available.
...
bp = Reading.READ_BIPARTITE_MATRIX('input_matrix.txt');
...
bp = Reading.READ_ADJACENCY_LIST('input_adja.txt.');
